...
(function () {
  ...
  const MOCK_PRODUCTS = [
    { id: "hy-essence",  handle: "dew-veil-essence",   title: "Dew Veil Essence",       category: "Essence",     price: 42, tag: "Bestseller", tone: "amber",
      ...
      i18n: { es: { title: "Esencia Velo de Rocío", description: "Una esencia hidratante ligera con baba de caracol y ácido hialurónico para una luminosidad de piel de cristal." } } },
    { id: "rice-cleanse", handle: "rice-milk-cleanser", title: "Rice Milk Cleanser",     category: "Cleanser",    price: 28, tag: null, tone: "cream",
      ...
      i18n: { es: { title: "Limpiador de Leche de Arroz", description: "Un limpiador de pH bajo, de gel a leche, que suaviza sin dañar la barrera de hidratación." } } },
    { id: "gin-toner",   handle: "ginseng-softening-toner", title: "Ginseng Softening Toner", category: "Toner", price: 34, tag: "New", tone: "rose",
      ...
      i18n: { es: { title: "Tónico Suavizante de Ginseng", description: "Ginseng fermentado y agua de arroz que tonifican, preparan y reafirman en un solo paso restaurador." } } },
    { id: "cica-cream",  handle: "cica-barrier-cream",  title: "Cica Barrier Cream",     category: "Moisturiser", price: 46, tag: null, tone: "sage",
      ...
      i18n: { es: { title: "Crema Barrera Cica", description: "Centella asiática y ceramidas que calman el enrojecimiento y reconstruyen una barrera resistente durante la noche." } } },
    { id: "prop-serum",  handle: "propolis-glow-serum", title: "Propolis Glow Serum",    category: "Serum",       price: 52, tag: "Bestseller", tone: "amber",
      ...
      i18n: { es: { title: "Suero Luminoso de Propóleo", description: "Propóleo de abeja negra y niacinamida que aportan un acabado clarificado y luminoso desde el interior." } } },
    { id: "rice-mask",   handle: "overnight-rice-mask", title: "Overnight Rice Mask",    category: "Mask",        price: 38, tag: null, tone: "cream",
      ...
      i18n: { es: { title: "Mascarilla de Arroz de Noche", description: "Una mascarilla de noche con extracto de arroz y escualano para una piel mullida y rellena al despertar." } } },
    { id: "spf-fluid",   handle: "airlight-sun-fluid",  title: "Airlight Sun Fluid SPF50+", category: "Sun",      price: 32, tag: "New", tone: "sage",
      ...
      i18n: { es: { title: "Fluido Solar Airlight SPF50+", description: "Una defensa diaria invisible y sin rastro blanco, con artemisa hidratante y filtros de amplio espectro." } } },
    { id: "eye-conc",    handle: "peptide-eye-concentrate", title: "Peptide Eye Concentrate", category: "Serum", price: 44, tag: null, tone: "rose",
      ...
      i18n: { es: { title: "Concentrado de Péptidos para Ojos", description: "Péptidos y cafeína de té verde que suavizan las líneas finas y descongestionan el delicado contorno de ojos." } } },
